...
list($width, $height, $ext) = getimagesize($_POST["imageSource"]);
...
$file = rtrim('upload', DIRECTORY_SEPARATOR) . '/' . $fileName;
parseImage($ext, $selector, $file);
imagedestroy($viewport);

//Return value
echo json_encode(array('url' => DOMAIN.$file, 'imageid'=> rand(1,9999)));
